...
// toggle state of GPIO output pin
...
#define TOGGLE_PIN(gpio)    gpio_toggle_pin(BRD_PORT(gpio), BRD_PIN(gpio))
...
#define GPIO_EN(gpio)	(((gpio) == PORT_A) ? RCC_IOPENR_GPIOAEN \
    ...
    : ((gpio) == PORT_D) ? RCC_IOPENR_GPIODEN \
    : ((gpio) == PORT_H) ? RCC_IOPENR_GPIOHEN \
	: 0)
#elif defined(STM32L1)
...
#define GPIO_EN(gpio)	(((gpio) == PORT_A) ? RCC_AHBENR_GPIOAEN \
    ...
    : ((gpio) == PORT_H) ? RCC_AHBENR_GPIOHEN \
	: 0)
#endif
...
//////////////////////////////////////////////////////////////////////
// I2C (moved to separate i2c.h due to include issues)
//////////////////////////////////////////////////////////////////////
...
// set/unset and initialize/deinitialize chip-select and spi pins
...
#if defined(BRD_DMA_CH2) || defined(BRD_DMA_CH3)
void dma_ch2_3_irq(void);
#endif
