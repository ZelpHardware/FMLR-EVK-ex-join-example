...
const irqdef HAL_irqdefs[] = {
...
#ifdef BRD_USART1
    { USART1_IRQn, usart_irq_handler_1 },
#endif
#ifdef BRD_USART2
    { USART2_IRQn, usart_irq_handler_2 },
#endif
#ifdef BRD_USART4
    { USART4_5_IRQn, usart_irq_handler_4 },
#endif
#ifdef BRD_LPUART1
    { LPUART1_IRQn, usart_irq_handler_1 },
#endif
    ...
    { DMA1_Channel2_3_IRQn, dma_ch2_3_irq },
#endif
...
static void debug_init (void) {
    ...
    DBG_USART->BRR = 278; // 278d --> 0x116 --> 115,200 baud (APB1 clock @32MHz)
