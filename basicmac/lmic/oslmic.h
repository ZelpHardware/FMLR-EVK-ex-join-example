...
#define osxticks2sec(os)  ((s8_t)(((os)               ) / OSTICKS_PER_SEC))
#define osxticks2ms(os)   ((s8_t)(((os)*(s8_t)1000    ) / OSTICKS_PER_SEC))
#define osxticks2us(os)   ((s8_t)(((os)*(s8_t)1000000 ) / OSTICKS_PER_SEC))
#endif
...
#endif
#ifndef os_getSlowestJoin
bool os_getSlowestJoin();
#endif
#ifndef os_setSlowestJoin
