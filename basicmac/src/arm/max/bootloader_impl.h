...
// EEPROM Emulation at the end of flash (2 pages)
#define DATA_EEPROM_BASE    (0x0007C000)          // @Todo: Transaction
#define DATA_EEPROM_SIZE    (0x2000)              // corresponds to one flash page
