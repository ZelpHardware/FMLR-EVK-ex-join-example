...
#define GPIO_RST	BRD_GPIO(PORT_C, 2)
#define GPIO_DIO0	BRD_GPIO(PORT_A, 1)
#define GPIO_DIO1	BRD_GPIO(PORT_A, 6)
#define GPIO_DIO2	BRD_GPIO(PORT_A, 7)
#define GPIO_DIO3	BRD_GPIO(PORT_C, 4)
#define GPIO_DIO4	BRD_GPIO(PORT_C, 5)
#define GPIO_DIO5	BRD_GPIO(PORT_B, 11)
